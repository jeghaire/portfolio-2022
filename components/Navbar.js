      ...
      <ul className="hidden md:flex items-center ml-auto">
        ...
        <li className="ml-5">
          <Link href="/cv/Jomavi.pdf" download>
            <a className="border inline-block outline-none rounded-lg py-3 px-7 hover:text-base-dark/80 font-mono hover:shadow-lg transition-all duration-400 ease-in-out active:scale-[0.96]">Resume</a>
          </Link>
        </li>
      </ul>
            ...
            >
              <ul className="h-full w-full flex flex-col">
                ...
                <li className="mt-5" onClick={() => setToggled(false)}>
                  <Link href="/cv/Jomavi.pdf" download>
                    <a className="border border-base-dark text-base-dark rounded-md transition-all duration-400 ease-in-out outline-none inline-block py-4 px-8 font-mono m-0 active:scale-[0.96]">Resume</a>
                  </Link>
                </li>
              </ul>
            </motion.div>
